// all are these models which are need to write code of controllers
...
const otp = async(req,res)=>{
    try{
      ...
      const result= await Otp.findOne({otp:otp});
        ...
        // this is bad bcz we need to again and again check in db for unique passwd
